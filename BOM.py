        ...
        try:
            if 'findbom.xls' in str(new_bom) or 'findbom.xlsx' in str(new_bom):
                ...
                if difference:
                    ...
                    print('octopartFrame',octopartFrame)
                    print('arrowFrame',arrowFrame)
                    print('mouserFrame',mouserFrame)
                    print('digikeyFrame',digikeyFrame)
                    print('enrgtechFrame',enrgtechFrame)
                    ...
                    for index, row in failures.iterrows():
                        ...
                        if height=='N/A' and mount=='N/A':
                            ...
                            if enrgtech_data['Enrgtech - Mounting'] != 'N/A' or enrgtech_data['Enrgtech - Package / Case'] != 'N/A' or enrgtech_data['Enrgtech - Height'] != 'N/A': 
                                ...
                                mouser_data = mouser_scraper(mrfp)
                                print('Mouser data:', mouser_data)
                                #  "Mouting Style": "",
                                # "Height": "",
                                # 'Datasheet': ''
                                if mouser_data['Mounting Style'] != 'N/A' or mouser_data['Height'] != 'N/A':
                                    if 'µm' in mouser_data['Height']:
                                        height = float(mouser_data['Height'].replace('µm','')) / 1000
                                        failures.loc[failures['Manufacturer PART NO.'] == mrfp, 'HT'] = height
                                    else:
                                        failures.loc[failures['Manufacturer PART NO.'] == mrfp, 'HT'] = mouser_data['Height']
                                    failures.loc[failures['Manufacturer PART NO.'] == mrfp, 'SMD/Through'] = mouser_data['Mounting Style']
                    ...
                    inster_record(database_dataframe)
